class rvm::passenger::apache::ubuntu::post(
  ...
  exec {
    'passenger-install-apache2-module':
      ...
      creates   => "${gempath}/passenger-${version}/libout/apache2/mod_passenger.so",
  ...
  file {
    '/etc/apache2/mods-available/passenger.load':
      ...
      content => "LoadModule passenger_module ${gempath}/passenger-${version}/libout/apache2/mod_passenger.so",
